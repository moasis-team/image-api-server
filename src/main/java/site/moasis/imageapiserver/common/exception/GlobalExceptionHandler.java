...
import site.moasis.imageapiserver.controller.CommonResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<CommonResponse> fileIOExceptionHandler(BusinessException e) {
        log.error("FileIOException -> errorCode: {}, errorMessage: {}", e.getErrorCode(), getErrorMessage(e));
